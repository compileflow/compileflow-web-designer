...
Editor.prototype.getGraphXml = function(ignoreSelection)
{
	...
	//byxuan
    node.setAttribute('cfCode', this.graph.dataCode || '');
    node.setAttribute('cfName', this.graph.dataName || '');
    node.setAttribute('cfType', this.graph.dataType || '');
    node.setAttribute('cfDescription', this.graph.dataDescription || '');
    node.setAttribute('cfGlobalVars', this.graph.dataGlobalVars || '');
