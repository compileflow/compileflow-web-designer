...
Format.prototype.refresh = function () {
    ...
    if (graph.isSelectionEmpty()) {
        //byxuan
        //点击空白触发
        mxUtils.write(label, mxResources.get('globalSettings'));
...
DiagramFormatPanel.prototype.init = function () {
    ...
    this.container.appendChild(this.addGlobalConfigs(this.createPanel()));
    this.container.appendChild(this.addGlobalVars(this.createPanel()));
 ...
 * byxuan设置全局变量
 */
DiagramFormatPanel.prototype.addGlobalVars = function (div) {
    var ui = this.editorUi;
    var editor = ui.editor;
    var graph = editor.graph;

    div.appendChild(this.createTitle(mxResources.get('globalVars')));

    //全局变量设置按钮
    var btn = mxUtils.button(mxResources.get('globalVarsBtn'), function (evt) {
        var dlg = new GlobalVarsDialog(graph, ui);
        ui.showDialog(dlg.container, 320, 400, true, true, function () {
...
DiagramFormatPanel.prototype.addGlobalConfigs = function (div) {
    var ui = this.editorUi;
    var editor = ui.editor;
    var graph = editor.graph;

    div.appendChild(this.createTitle(mxResources.get('globalConfigs')));

    //code
    var codeLabel = document.createElement('span');
    codeLabel.style.display = 'inline-block';
    codeLabel.style.width = '70px';
    codeLabel.innerText = "code：";
    div.appendChild(codeLabel);
    var codeInput = document.createElement('input');
    codeInput.style.marginBottom = "5px";
    codeInput.onblur = function () {
        graph.dataCode = codeInput.value;
    };
    ...
    nameInput.onblur = function () {
        graph.dataName = nameInput.value;
    };
    ...
    descriptionLabel.style.width = '70px';
    descriptionLabel.innerText = "description：";
    div.appendChild(descriptionLabel);
    var descriptionInput = document.createElement('input');
    descriptionInput.style.marginBottom = "5px";
    descriptionInput.onblur = function () {
        graph.dataDescription = descriptionInput.value;
    };
